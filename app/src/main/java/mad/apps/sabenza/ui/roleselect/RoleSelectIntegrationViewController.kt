...
class RoleSelectIntegrationViewController : BaseViewController(), RoleSelectViewInterface {
    ...
    val gotoLoginButton by bindView<FrameLayout>(R.id.goto_login_screen)
